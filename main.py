...
def start_training(character):
    ...
    commands = {'Warrior': 'ты Воитель — великий мастер ближнего боя.',
                'Mage': 'ты Маг — превосходный укротитель стихий.',
                'Healer': 'ты Лекарь — чародей, способный исцелять раны.',
                'attack': character.attack(),
                'defence': character.defence(),
                'special': character.special()}
    print(f"{character.name}, {commands[character.__class__.__name__]}")  # Точно так?
...
warrior.char_class = choice_char_class('Кодослав')
